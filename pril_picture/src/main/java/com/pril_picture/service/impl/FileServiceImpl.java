package com.pril_picture.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.pril_base.enums.EFilePriority;
import com.pril_base.enums.EOpenStatus;
...
import com.pril_base.vo.FileVO;
import com.pril_common.entity.File;
import com.pril_common.entity.FileSort;
import com.pril_common.entity.SystemConfig;
import com.pril_picture.global.MessageConf;
import com.pril_picture.global.SQLConf;
import com.pril_picture.global.SysConf;
import com.pril_picture.mapper.FileMapper;
import com.pril_picture.service.*;
import com.pril_picture.util.AboutFileUtil;
import com.pril_picture.util.FeignUtil;
import com.pril_utils.utils.FileUtils;
...
public class FileServiceImpl extends SuperServiceImpl<FileMapper, File> implements FileService {
    ...
    public String getPicture(String fileIds, String code) {
        ...
        if (StringUtils.isEmpty(fileIds)) {
            ...
            QueryWrapper<com.pril_common.entity.File> queryWrapper = new QueryWrapper<>();
            queryWrapper.in(SQLConf.UID, changeStringToString);
            List<com.pril_common.entity.File> fileList = fileService.list(queryWrapper);
            if (fileList.size() > 0) {
                for (com.pril_common.entity.File file : fileList) {
                    if (file != null) {
    ...
    public String uploadPictureByUrl(FileVO fileVO) {
        ...
        List<com.pril_common.entity.File> lists = new ArrayList<>();
        //文件上传
        if (urlList != null && urlList.size() > 0) {
            for (String itemUrl : urlList) {
                ...
                com.pril_common.entity.File file = new com.pril_common.entity.File();
                file.setCreateTime(new Date(System.currentTimeMillis()));
                file.setFileSortUid(fileSort.getUid());
